...
embeded_model.fit(tmp_x, preproc_french_sentences, batch_size=1024, epochs=20, validation_split=0.2)
...
embeded_model.fit(tmp_x, preproc_french_sentences, batch_size=1024, epochs=30, validation_split=0.2)
...
embeded_model.fit(tmp_x, preproc_french_sentences, batch_size=1024, epochs=40, validation_split=0.2)
...
embeded_model.fit(tmp_x, preproc_french_sentences, batch_size=1024, epochs=50, validation_split=0.2)
...
for i in range(len(tmp_x)):
  predicted = logits_to_text(embeded_model.predict(tmp_x[i])[0], french_tokenizer)
